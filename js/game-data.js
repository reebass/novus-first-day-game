  ...
  window.NOVUS_GAME_DATA = {
    ...
    screens: {
      ...
      tourQuestion1: {
        ...
        type: "question",
        progress: "tour",
        title: "Екскурсія торговельним центром",
        text: [
      ...
      cashierQuestion2: {
        ...
        success: "Супер! Ви допомагаєте клієнту й водночас дієте за процесом.",
      ...
      cashierQuestion3: {
        ...
        answers: [
          ...
          { id: "bank", label: "Повідомлю клієнту, що ми не пропонуємо послугу обміну готівки, це повноваження банку", correct: true },
          { id: "senior", label: "Покличу старшого касира для розміну" }
        ],
        success: "Влучно! Ви коректно пояснили ситуацію і не вийшли за межі повноважень.",
      ...
      shelfQuestion1: {
        ...
        success: "Гарна реакція! Ви не залишаєте клієнта без рішення.",
        next: "shelfQuestion2"
      },
      shelfQuestion2: {
        id: "shelfQuestion2",
        ...
        success: "Саме так! Ви скеровуєте клієнта до відповідного фахівця, який зможе якнайшвидше допомогти з його питанням.",
      ...
      counterQuestion1: {
        ...
        success: "Супер! Ви швидко знаходите інформацію й допомагаєте клієнту зробити вибір.",
      ...
      counterQuestion3: {
        ...
        success: "Гарний вибір! Ви не перериваєте обслуговування і водночас не ігноруєте іншого клієнта.",
      ...
      counterQuestion4: {
        ...
        success: "Чудово! Ви допомагаєте клієнту знайти альтернативу й не залишаєте його без рішення.",
        next: "final"
      },
      final: {
        id: "final",
      ...
      thanks: {
        ...
        type: "thanks",
        progress: "form",
        title: "Дякуємо! Ми вже чекаємо на вас!",
        text: ["Наші фахівці найближчим часом зв’яжуться з вами щодо вакансій NOVUS."],
        scene: "final",
        hero: "happy",
        showHeroOverlay: false
      },
