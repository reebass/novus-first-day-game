    ...
    screens: {
      ...
      manager: {
        ...
        actions: [
          ...
          { label: "Отримання спеціального одягу та екскурсія ТЦ", next: "uniform" }
        ]
      },
      trainingIntro: {
        id: "trainingIntro",
      ...
      trainingQuestion3: {
        ...
        success: "Чудово! Саме на турботі, надійності та раціональності тримається наша корпоративна культура.",
        next: "uniform"
      },
      uniform: {
        id: "uniform",
        ...
        text: ["Ми впевнені вам дуже личитемуть брендовані зелені елементи!"],
        scene: "uniform",
        hero: "happy",
        showHeroOverlay: false,
        actions: [
      ...
      tourQuestion2: {
        ...
        success: "Гарний вибір! Навіть у перший день можна допомогти клієнту знайти правильний напрям.",
        next: "roleChoice"
      },
      roleChoice: {
        id: "roleChoice",
      ...
      cashierQuestion2: {
        ...
        next: "cashierQuestion3"
      },
      cashierQuestion3: {
        id: "cashierQuestion3",
        type: "question",
        progress: "practice",
        title: "Касир. Питання 3",
        text: [
      ...
      shelfQuestion2: {
        ...
        success: "Саме так! Ти направляєш клієнта туди, де йому зможуть правильно допомогти.",
        next: "shelfQuestion3"
      },
      shelfQuestion3: {
        id: "shelfQuestion3",
      ...
      counterQuestion2: {
        ...
        next: "counterQuestion3"
      },
      counterQuestion3: {
        id: "counterQuestion3",
        type: "question",
        progress: "practice",
        title: "Прилавок. Питання 3",
        text: [
          "Обслуговую клієнта.",
      ...
      final: {
        ...
        type: "finalForm",
        progress: "form",
        title: "Ось і минув твій перший день у NOVUS.",
        text: [
          ...
          "Якщо тебе зацікавила робота в NOVUS, дай відповідь на декілька простих запитань, щоб наші фахівці могли з тобою підтримувати контакт."
        ],
        scene: "final",
        hero: "celebrate",
        showHeroOverlay: false
